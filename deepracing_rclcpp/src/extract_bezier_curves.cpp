...
int main(int argc, char** argv)
{
    ...
    std::vector< std::shared_ptr<deepracing_msgs::msg::BezierCurve> > bezier_curves;
    std::vector< std::shared_ptr<deepracing_msgs::msg::TimestampedPacketMotionData> > motion_packets;
    ...
    while(reader.has_next())
    {
        ...
        {
            std::shared_ptr<deepracing_msgs::msg::BezierCurve> bezier_curve_msg(new deepracing_msgs::msg::BezierCurve);
        ...
        {
            std::shared_ptr<deepracing_msgs::msg::TimestampedPacketMotionData> motion_packet_msg(new deepracing_msgs::msg::TimestampedPacketMotionData);
    ...
    {
        std::shared_ptr<deepracing_msgs::msg::BezierCurve> bezier_curve_msg = bezier_curves[i];
        rclcpp::Time timestamp = bezier_curve_msg->header.stamp;
