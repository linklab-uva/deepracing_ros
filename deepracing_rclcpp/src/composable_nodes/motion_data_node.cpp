    ...
    class ReceiveMotionData : public rclcpp::Node
    {
        public:
                ...
                rclcpp::Node("receive_motion_data", options)
            {
                ...
                m_publisher_ = create_publisher<deepracing_msgs::msg::TimestampedPacketMotionData>("motion_data", 10);
        ...
        private:
            ...
            rclcpp::Publisher<deepracing_msgs::msg::TimestampedPacketMotionData>::SharedPtr m_secondary_publisher_;
