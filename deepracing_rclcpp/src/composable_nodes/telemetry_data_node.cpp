    ...
    class ReceiveTelemetryData : public rclcpp::Node
    {
        public:
                ...
                rclcpp::Node("receive_telemetry_data", options)
            {
                ...
                m_publisher_ = create_publisher<deepracing_msgs::msg::TimestampedPacketCarTelemetryData>("telemetry_data", 10);
        ...
        private:
            ...
            {
                deepf1::twenty_twenty::PacketCarTelemetryData* udp_data = reinterpret_cast<deepf1::twenty_twenty::PacketCarTelemetryData*>((void*)&(udp_packet->data.at(0)));
                ...
                {
                    deepracing_msgs::msg::TimestampedPacketCarTelemetryData rosdataflipped(rosdata);
                    ...
                    m_secondary_publisher_->publish(std::make_unique<deepracing_msgs::msg::TimestampedPacketCarTelemetryData>(rosdataflipped));
                }
            ...
            rclcpp::Publisher<deepracing_msgs::msg::TimestampedPacketCarTelemetryData>::SharedPtr m_secondary_publisher_;
